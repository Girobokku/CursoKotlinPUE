package edu.pue.appcursopue.mapa
...
import edu.pue.appcursopue.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onRequestPermissionsResult(
        ...
        {
            Log.d(ETIQUETA_LOG, "tenemos permiso para acceder a la ubicación")
            //?tengo acceso al GPS
            if (gpsEstaActivado())
            {
                //acceso a la ubicación
            ...
            Log.d(ETIQUETA_LOG, "NO tenemos permiso para acceder a la ubicación")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (gpsEstaActivado())
        {
            ...
            Log.d(ETIQUETA_LOG, "GPS DESACTIVADO")
            Toast.makeText(this, "GPS DESACTIVADO - SIN ACCESO A LA UBICACIÓN", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun mostrarUbicacionObtenida(ubicacion: Location) {
        Log.d(ETIQUETA_LOG, "Mostrando ubicación obtenida ... $ubicacion ")
